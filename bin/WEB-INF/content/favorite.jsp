...
<body>
	...
	<div id="page-content" class="single-page">
		<div class="container">
			...
			<div class="row"><c:forEach items="${requestScope.favorite_list}" var="favorite">
				<div class="product well">
					<div class="col-md-3">
						<div class="image">
							<img src="images/${favorite.goods.image}" />
						</div>
					</div>
					<div class="col-md-9">
						<div class="caption">
							<div class="name"><h3> ${favorite.goods.name}</h3></div>
							<div class="price"> ${favorite.goods.price}</div>
							<hr>
  							<a href="deleteFavorite?id=${favorite.id}&username=${user.username}" class="btn btn-default pull-right">删除</a>	
						</div>
					</div>
					<div class="clear"></div>
				</div>	
