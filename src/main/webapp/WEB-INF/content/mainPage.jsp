				  ...
				  <div class="container-fluid">
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav">
				        ...
				        <li><a>在线人数：${applicationScope.count}</a></li>
				      </ul>
				     </div>
				  </div>
				</nav>
			...
			<div class="span4">
				<div class="alert alert-success">
				        <a class="close" data-dismiss="alert">×</a>
				        	${requestScope.messageF}
				</div>
			</div>
			<div class="row"><c:forEach items="${requestScope.goods_list }" var="goods">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="product">
						<div ><a href="showGoodsDetail?id=${goods.id}&user.id=${user.id}"><img src="images/${goods.image}" height="60"></a></div>
						<div class="buttons">
							<a class="btn cart" href="addCart?goods.id=${goods.id}&user.id=${user.id}&number=1&username=${user.username}"><span class="glyphicon glyphicon-shopping-cart"></span></a>
							<a class="btn wishlist" href="addFavorite?goods.id=${goods.id}&user.id=${user.id}&username=${user.username}"><span class="glyphicon glyphicon-heart"></span></a>
							<a>销量：${goods.sales}</a>
						</div>
						<div class="caption">
